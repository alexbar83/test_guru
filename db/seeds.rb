...
answers = Answer.create([{ body: 'Австралия', correct: true, question: questions.first },
                         ...
                         { body: 'Маск', question: questions[2] },

                         { body: '988', correct: true, question: questions[3] },
                         { body: '1088', question: questions[3] },
                         { body: '986', question: questions[3] },
